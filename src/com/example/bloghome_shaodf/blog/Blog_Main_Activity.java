...
public class Blog_Main_Activity extends Activity {

	String path = "http://wcf.open.cnblogs.com/blog/sitehome/paged/1/30";
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			if (msg.what == 10) {
				adapter = new Blog_Main_Adapter(Blog_Main_Activity.this, list);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(Blog_Main_Activity.this,
