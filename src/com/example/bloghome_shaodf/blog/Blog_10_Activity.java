...
public class Blog_10_Activity extends Activity{

	String path = "http://wcf.open.cnblogs.com/blog/TenDaysTopDiggPosts/50";
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			if (msg.what == 10) {
				adapter = new Blog_Main_Adapter(Blog_10_Activity.this, list);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent intent = new Intent(Blog_10_Activity.this,
